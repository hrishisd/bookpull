...
def test_parse_small_doc_footnotes():
...
def test_parse_sample_article_footnotes():
    assert_parse_footnotes(
        "tests/resources/sample-article-paragraph.docx",
        [
            "389 U.S. 347 (1967); see, e.g., Kiel Brennan-Marquez, Outsourced "
            + "Law Enforcement, 18 U. Pa. J. Const. L. 797, 801 (2016) (noting"
            + " that Katz “ushered in the modern era of Fourth Amendment law”)"
            + ".",
